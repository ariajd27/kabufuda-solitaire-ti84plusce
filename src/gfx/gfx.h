...
#define KBFDGFX_highcontrast_card1_index 1
#define card1 ((gfx_sprite_t*)KBFDGFX_appvar[1])
#define card10_width 25
#define card10_height 41
#define KBFDGFX_highcontrast_card10_index 2
#define card10 ((gfx_sprite_t*)KBFDGFX_appvar[2])
#define card2_width 25
#define card2_height 41
#define KBFDGFX_highcontrast_card2_index 3
#define card2 ((gfx_sprite_t*)KBFDGFX_appvar[3])
#define card3_width 25
#define card3_height 41
#define KBFDGFX_highcontrast_card3_index 4
#define card3 ((gfx_sprite_t*)KBFDGFX_appvar[4])
#define card4_width 25
#define card4_height 41
#define KBFDGFX_highcontrast_card4_index 5
#define card4 ((gfx_sprite_t*)KBFDGFX_appvar[5])
#define card5_width 25
#define card5_height 41
#define KBFDGFX_highcontrast_card5_index 6
#define card5 ((gfx_sprite_t*)KBFDGFX_appvar[6])
#define card6_width 25
#define card6_height 41
#define KBFDGFX_highcontrast_card6_index 7
#define card6 ((gfx_sprite_t*)KBFDGFX_appvar[7])
#define card7_width 25
#define card7_height 41
#define KBFDGFX_highcontrast_card7_index 8
#define card7 ((gfx_sprite_t*)KBFDGFX_appvar[8])
#define card8_width 25
#define card8_height 41
#define KBFDGFX_highcontrast_card8_index 9
#define card8 ((gfx_sprite_t*)KBFDGFX_appvar[9])
#define card9_width 25
#define card9_height 41
#define KBFDGFX_highcontrast_card9_index 10
#define card9 ((gfx_sprite_t*)KBFDGFX_appvar[10])
#define cardstack_width 25
#define cardstack_height 45
#define KBFDGFX_highcontrast_cardstack_index 11
#define cardstack ((gfx_sprite_t*)KBFDGFX_appvar[11])
#define freespace_width 25
#define freespace_height 41
#define KBFDGFX_highcontrast_freespace_index 12
#define freespace ((gfx_sprite_t*)KBFDGFX_appvar[12])
#define lock_width 7
#define lock_height 8
#define KBFDGFX_highcontrast_lock_index 13
#define lock ((gfx_sprite_t*)KBFDGFX_appvar[13])
#define selcorner_width 29
#define selcorner_height 45
#define KBFDGFX_highcontrast_selcorner_index 14
#define selcorner ((gfx_sprite_t*)KBFDGFX_appvar[14])
#define drpcorner_width 29
#define drpcorner_height 45
#define KBFDGFX_highcontrast_drpcorner_index 15
